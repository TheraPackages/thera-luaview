...
import AtomLuaviewView    from './atom-luaview-view';
...
export default {
  ...
  activate(state) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      'atom-luaview:toggle': () => this.toggle(),
      'atom-luaview:nextStep': () => this.nextStep(),
      'atom-luaview:nextLine': () => this.nextLine(),
      'atom-luaview:nextBreakPoint': () => this.nextBreakPoint(),
      'atom-luaview:setupDebugServer': () => this.setupDebugServer(),
      'atom-luaview:closeDebugServer': () => this.closeDebugServer(),
      'atom-luaview:setBreakpoint': () => this.setBreakpoint(),
      'atom-luaview:removeBreakpoint': () => this.removeBreakpoint(),
    }));
